...
export default function ResetPreference({ isLoggedIn }: Props) {
  ...
  return (
    <div className="flex flex-col w-full max-w-[375px] px-5 min-w-0 items-center justify-center">

      {/* 취향 재설정 버튼 */}
      <div
        className="flex w-full bg-[#FF3637] mt-10 py-3 items-center cursor-pointer min-w-0 rounded-[4px]"
      ...
      >
        ...
        <div className="w-4 ml-1 shrink-0 flex items-center mr-auto">
      ...
      <div className="flex w-full bg-black mt-2 min-w-0 gap-2">
        ...
        <div
          className="flex px-4 py-2 gap-3 justify-center items-center
            bg-[#1F1D1D] border-[#413D3D] border-0.25 rounded-[20px] shrink-0"
        >
          <button
            type="button"
