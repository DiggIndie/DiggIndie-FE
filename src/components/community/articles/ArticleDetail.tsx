...
export default function ArticleDetail<T extends ArticleBase>({ article, author, comments, users, }: Props<T>) {
  return (
    <div className="min-h-screen bg-black text-white">
      <ArticleHeader />
      <ArticleAuthorRow author={author} written={article.written} />
